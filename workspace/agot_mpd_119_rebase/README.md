# agot_mpd_119_rebase — module state

Narrow runtime repair for Workshop mod **AGOT - More Personality Depth**
(`3717990443`, version `0.4.0`) on AGOT `0.4.40` / CK3 `1.19`. Load position:
immediately after MPD and before the local MPD + Dragon Wives GUI compatch.
...
The `mod.toml` manifest declares both Workshop parents, the staged generator,
and the exact output paths it owns.

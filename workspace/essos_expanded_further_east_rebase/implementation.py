...
def generate(context: GenerationContext) -> None:
    source = context.source("further-east-eep")
    write_text(
        context.output_root,
        TITLE_HISTORY,
        remove_dated_capitals(read_text(source / TITLE_HISTORY)),
    )
    write_text(
        context.output_root,
        PROVINCE_HISTORY,
        rewrite_lay_clergy_temples(read_text(source / PROVINCE_HISTORY)),
    )

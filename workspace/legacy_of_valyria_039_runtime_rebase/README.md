# legacy_of_valyria_039_runtime_rebase — module state

Generated startup-script rebase for **Legacy of Valyria - AGOT Temporary
Compatch RC71** (`3719888822`) on the current AGOT source. Load position:
immediately after that compatch and before Essos Expanded.
...
The generator pins the AGOT and RC71 startup inputs and the AGOT pirate-domicile

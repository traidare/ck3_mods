...
- **Merged traditions.** Armies of Westeros' culture-tradition definitions are
  ...
  traditions. Current AGOT's Stormlands, Ibbenese, Ironmen, Frozen Shoremen,
  Harbormen, Stoneborn, and Wolfswood Clansmen traditions are carried through
  because Armies of Westeros defines them with divergent values while Mayham
  carries AGOT's current block. Mayham's own Stoneborn and Wolfswood deltas
  apply on top. This preserves Armies of Westeros' MAA unlocks, parameters,
  costs, and AI behavior alongside Mayham's opinion values and AGOT's current
  cultural-tradition bonuses. Greenborn, Ironborn, and Marcher remain supplied
  by the complete Armies of Westeros rebase after their exact parent

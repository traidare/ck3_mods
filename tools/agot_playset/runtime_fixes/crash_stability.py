...
# AGOT and the LoV bridge each ship a whole-file copy of the interaction, and
# both carry the same three unguarded score calls, so the repair has to be
# rebased from whichever copy is the effective last writer in the profile.
APPOINTMENT_SCORE_SOURCES = {
    "2962333032": (
        "8d72c1d772f22b989b57e9464b3add6d316877555a831c20e2aecd6663ee2ef0",
...
def generate_accolade_lifecycle_stability(
    inputs: RunInputs, *, include_lov: bool = True, include_core: bool = True
) -> None:

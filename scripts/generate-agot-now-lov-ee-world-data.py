...
def main() -> int:
    ...
    module = root / "mods/agot_now_lov_ee_world_data"
    source = module / "content_source/world_data"
    mask_config_path = source / "terrain_mask_groups.toml"
    decisions_path = source / "terrain_decisions.csv"
    ...
    terrain_lines = [
        "\ufeff# Generated by scripts/generate-agot-now-lov-ee-world-data.py.",

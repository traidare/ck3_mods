...
module's parents and destination-specific staged generator. It checks exact
replacement counts and stops when a parent update invalidates an assumption.
Re-run it and review the resulting diff after any update to Workshop IDs

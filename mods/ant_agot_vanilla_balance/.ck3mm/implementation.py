...
def generate_traditions() -> None:
    ...
    content = "# Generated by ck3mm from the colocated .ck3mm implementation.\n\n"
...
def generate_modifiers() -> None:
    content = r"""# Generated by ck3mm from the colocated .ck3mm implementation.
...
def generate_common_buildings() -> None:
    ...
    content = (
        "# Generated by ck3mm from the colocated .ck3mm implementation.\n\n"
        + "\n\n".join(blocks)
    )

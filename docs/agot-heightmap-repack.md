...
export heightmap_source="workspace/agot_playset_lov_ee_compatch/artifacts/heightmap/heightmap_now_delta_unpacked.png"
...
cp mods/agot_playset_lov_ee_compatch/map_data/{heightmap.png,heightmap.heightmap,packed_heightmap.png,indirection_heightmap.png} \
...
cp "$heightmap_stage"/map_data/{heightmap.png,heightmap.heightmap,packed_heightmap.png,indirection_heightmap.png} \
  mods/agot_playset_lov_ee_compatch/map_data/
ck3mm mod install agot_playset_lov_ee_compatch
ck3mm mod install agot_playset_lov_ee_compatch --apply
ck3mm mod validate agot_playset_lov_ee_compatch
ck3mm conflicts AGOT \
  --files \
  --involving mod/agot_playset_lov_ee_compatch.mod
```

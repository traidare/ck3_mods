...
from .text import (
    definition_span as common_definition_span,
)
from .text import (
    matching_brace,
    read_source,
...
MOD_OUTPUT_ROOT: Path | None = None
...
def definition_span(text: str, name: str) -> tuple[int, int]:
    return common_definition_span(
        text,
        name,
        indent=r"\t\t",
        consume_line_end=True,
    )
